...
var AxiomProvider = ({
  ...
  const [deadLetters, setDeadLetters] = (0, import_react.useState)([]);
  ...
  const clearDeadLetters = (0, import_react.useCallback)(() => setDeadLetters([]), []);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AxiomContext.Provider, { value: {
    isOnline,
